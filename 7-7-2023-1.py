...
'''def open_data_window():
    ...
    #data_window.attributes("-fullscreen", True)  # substitute `Tk` for whatever your `Tk()` object is called
...
def open_scenario_window():
    print ('enter open_scenerio_window function')
    ...
    #scenario_window.attributes("-fullscreen", True)  # substitute `Tk` for whatever your `Tk()` object is called
    #Add Title frame
    ...
    button_scenario = Button(scenario_window, text="Begin", command = function,  font=("Arial", mediumtitletext),bg="firebrick3",fg="white", padx=30)
    button_scenario.grid(row=2, column=1, padx=50, pady=5)   

#----------------------------------------------------------------------------------
MAX_MOTOR_SPEED = 0
def function():
    global method, sound, liquid, speed, MAX_MOTOR_SPEED
    print ('enter function function')
    print ('method', method.get())
    print ('Sound', sound.get())
    print ('liquid', liquid.get())
    print ('Speed', speed.get())
    ...
    print('MAX MOTOR SPEED = ', MAX_MOTOR_SPEED)    
...
#---------------------------------------    
    ...
    def graph_function(t, d):
        print ('enter graph_function function')    
        ma_x = []
        x = t #[]
        m = d #[]
        ma_x.append(20)
        ...
        canvas_graph.draw()
        root.after(100, graph_function)  # Schedule the next update after 1000ms (1 second)
...
#-----------------------------------------------------------
    ...
    #Junction Wound
    print('junction wound')
    print ('method=', method.get())
    while method.get() == 1 :
        print ('enter junction while loop')
        #time stamp is taken
    ...
    #---------------------------------------
        if liquid == 1:
            print ('enter if liquid = 1 Junction')
