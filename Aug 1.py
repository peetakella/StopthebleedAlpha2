...
def function(m, s, l):
    ...
    if s == 1:
        background = threading.Thread(target=background)
...
#-----------------------------------------------------------    
    ...
    def background():
        pygame.mixer.init()
        pygame.mixer.music.load("/home/stopthebleed/StoptheBleed/Sounds/police-siren-water-cannon-tear-gas-people-coughing-and-protesters-throwing-stones-at-the-police-during-the-chilean-uprising-november-2019-24871.mp3")
    ...
    #----------------------------------------
        bleedoutbar_thd = threading.Thread(target=bleedoutbar, args=(BloodLost))
        bleedoutbar_thd.daemon = True
        bleedoutbar_thd.start()        
