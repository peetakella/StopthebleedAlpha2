...
def open_scenario_window():
    ...
    button_scenario = Button(scenario_window, text="Begin", command = lambda: [function(method.get(), speed.get(), liquid.get())],  font=("Arial", 20),bg="firebrick3",fg="white", padx=30)
